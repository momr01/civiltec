...
const customThemeFooter: CustomFlowbiteTheme["footer"] = {
  root: {
    base: "w-full rounded-none bg-mainGreen shadow dark:bg-gray-800 md:flex md:items-center md:justify-between",
  },
};
